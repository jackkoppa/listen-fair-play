...
export default [
  {
    input: 'lambda-1/retrieve-rss-feeds-and-download-audio-files.ts',
    output: {
      file: 'aws-dist/lambda-1/retrieve-rss-feeds-and-download-audio-files.cjs',
      format: 'cjs',
      sourcemap: true,
    },
    plugins,
  ...
  {
    input: 'lambda-2/process-new-audio-files-via-whisper.ts',
    output: {
      file: 'aws-dist/lambda-2/process-new-audio-files-via-whisper.cjs',
      format: 'cjs',
      sourcemap: true,
    },
    plugins,
  ...
  {
    input: 'lambda-3/convert-srt-files-into-search-entries.ts',
    output: {
      file: 'aws-dist/lambda-3/convert-srt-files-into-search-entries.cjs',
      format: 'cjs',
      sourcemap: true,
    },
    plugins,
